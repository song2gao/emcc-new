...
<title>Insert title here</title>
		...
		<link rel="stylesheet" type="text/css"
			href="/emcc-new/component/jquery-easyui/themes/default/easyui.css">
		<link rel="stylesheet" type="text/css"
			href="/emcc-new/component/jquery-easyui/themes/icon.css">
		<script type="text/javascript"
			src="/emcc-new/js/jquery-1.7.2.js"></script>
		<script type="text/javascript"
			src="/emcc-new/component/jquery-easyui/jquery-1.7.2.min.js"></script>
		<script type="text/javascript"
