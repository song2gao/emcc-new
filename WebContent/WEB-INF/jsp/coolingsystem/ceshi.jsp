...
function GetData() {
	var args = {};
	mydate=$("#indate").val();
	BingData("#fhtb", args, 'point?date='+mydate+'&flag='+flag,null);
}
</script>
<!-- 表格展示 -->
<script>
			...
			<div class="container-fluid paper-wrap bevel tlbr" style="width:100%">
				...
				<div class="content-wrap" style="border: 0px solid green;padding:0px;">
					...
					<div class="col-sm-10" style="float:left;width:100.0%;border: 0px solid red ;padding-left:10px;margin-top: 1%;height:87%;">
						...
						<input type="radio" name="rdmmps" checked="" value="1"/>东站供暖系统
						<input type="radio" name="rdmmps" value="2"/>东站生活用水系统
						<input type="radio" name="rdmmps" checked="checked" value="3"/>东站制冷系统
						<input type="radio" name="rdmmps" value="4"/>西站供暖系统
						<input type="radio" name="rdmmps" value="5"/>西站生活用水系统
						<input type="radio" name="rdmmps" value="6"/>西站制冷系统
						<input class="datainp" id="indate" type="text" placeholder="YYYY-MM-DD" style="color:black"  readonly>
						<input type="button" class="button" style="margin-left:1%;background-color: #008CBA;" onclick="GetData()" value="查询"/>
						<input type="button" id="btnExport" class="button" style="margin-left:1%;background-color: #008CBA;" onclick="exportExcel()" value="导出"/>
						</div>
						<!-- 数据列表 -->
