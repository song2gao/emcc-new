...
<html>
	<head>
		<meta charset="utf-8">
		<title>冷热源分项分析-中惠元景能耗监测平台</title>
	...
	$(function() {
		...
		$("#enddate").datebox('setValue', str);
		 ...
		 $("#ccType").combobox({  
	         ...
	         onChange:function(){  
	             mmpCode = $("#ccType").combobox("getValue");
	         }
		 });
		myenddate = str;
		InifhTable();
	...
	function GetData() {
		...
		BingData("#fhtb", args,
				'daymonyearsum?ctdCode='
						+ id +'&dateBeginCode=' + mybegindate+'&energyType=5&flag='+flag+'&mmpCode='+mmpCode, null);
	}
				...
				<div class="content-wrap"
					...
					<div class="row"
						...
						<div class="col-sm-2 box-shadow-2"
							...
							<iframe src="tree?type=5" width="100%" style="border: 0px"
						...
						<div class="col-sm-10"
							...
							<div class="col-xs-3 box-shadow-2"
								...
								<div style="float: left">
									冷热源类型：
							<select id="ccType" class="easyui-combobox" style="width: 100px">  
    							<option value="65" selected="selected">热源</option>  
    							<option value="66">冷源</option>  
							</select>  
