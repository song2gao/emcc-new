				...
				<div class="row" style="border: 0px solid green; margin-left: 0.2%;">
					<div class="col-sm-10"
						...
						<div class="col-xs-3 box-shadow-2"
							...
							<input type="radio" name="rdmmps" checked="" value="1" />
							<input type="radio" name="rdmmps" checked="" value="2" />
						...
						<div class="col-xs-4 box-shadow-2" id="table"
							...
							<table id="fhtb" title="热  力  管  理  部  西  站  能  耗  表"
								...
								<thead>
									...
									<tr>
										<th rowspan="2" data-options="field:'timeCode',width:80,align:'center'">底数</th>
										<th rowspan="2" data-options="field:'timeCode',width:80,align:'center'" >用量</th>
