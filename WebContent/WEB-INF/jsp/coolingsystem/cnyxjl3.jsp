					...
					<div class="col-sm-10"
						...
						<div class="col-xs-4 box-shadow-2" id="table"
							...
							<table id="fhtb" class="easyui-datagrid"
								...
								<thead frozen="true">
									<tr>
										<th field="dateCode" width="200"  align="center" >日期</th>
									</tr>
								</thead>
								<thead>
									<tr>
										<th colspan="2">总水表（周查）</th>
										<th rowspan="2" field="ctdName" width="150">底数</th>
										<th rowspan="2" field="mmpName" width="60" align="center">用量</th>
									</tr>
									<tr>
										<th field="ctdName" width="80" align="right">底数</th>
										<th field="mmpName" width="80" align="right">用量</th>
									</tr>
								</thead>
							</table>
						</div>
