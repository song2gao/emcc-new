	...
	function GetData() {
		...
		BingData("#fhtb", args,
				'daymonyearsum?ctdCode='
						+ id +'&dateBeginCode=' + mybegindate+'&energyType=2&flag='+flag+'&mmpCode='+mmpCode, null);
	}
				...
				<div class="content-wrap"
					...
					<div class="row"
						...
						<div class="col-sm-2 box-shadow-2"
							...
							<iframe src="tree?type=2" width="100%" style="border: 0px"
