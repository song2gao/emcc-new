...
<html>
	<head>
		...
		<script type="text/javascript"
				src="${pageContext.request.contextPath}/fusioncharts-xt/js/fusioncharts.js"></script>
		<script type="text/javascript"
				src="${pageContext.request.contextPath}/fusioncharts-xt/js/themes/fusioncharts.theme.fint.js"></script>
<script>
var id="";
var mydate="";
var type="2";
...
function freshPage() {
	//单击加载图标数据
	$.ajax({
		url:"../statistics/dldhdata?id="+id+"&type="+type+"&date="+mydate,
		dataType:"json",
					...
					<div class="row" style="border: 0px solid green;margin-left:0.2%;">
						...
						<div class="col-sm-10"
							...
							<div class="col-xs-3 box-shadow-2" style="float:left;width: 99%;height: 10%;padding:15px 0 0 15px;color:gray">
								<input type="radio" name="rdmmps" value="2" checked="checked" />月份查询
						...
						<div class="col-xs-4" style="border: 0px solid; width:62%; height: 90%;margin-top: 1%;padding:0px;float:left">
								<div class="col-xs-4 box-shadow-2" style="border: 0px solid;width:100%;height: 48.1%;;">
									<div style="height: 90%; width: 49%;float:left;" scrolling="no" frameborder="0" marginheight="0" src="" id="dlqs"></div>
									<div style="height: 90%; width: 49%;float:left;" scrolling="no" frameborder="0" marginheight="0" id="dlpie"></div>
								</div>
								<div class="col-xs-4 box-shadow-2" style="border: 0px solid;width:100%;height: 48.2%;margin-top: 1.5%;">
									<div style="height: 90%; width: 49%;float:left;" scrolling="no" frameborder="0" marginheight="0" id="dfqs"></div>
									<div style="height: 90%; width: 49%;float:left;" scrolling="no" frameborder="0" marginheight="0" id="dfpie"></div>
								</div>
						</div>
