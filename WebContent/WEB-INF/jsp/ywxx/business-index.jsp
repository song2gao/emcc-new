...
<link href="/emcc-web/css/poms-business/businessIndex.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="/emcc-web/js/poms-system/time.js"></script>
		...
		$(function(){
			...
			data:{
				...
				"pageSize":7
					...
					$.each(data.list, function(i,item) {
						var tr = "<tr><td><div class='contentLeft'><img src='/emcc-web/image/poms-business/picture/gdblue.png' />&nbsp;<a href='#' class='gdAndDtA' id='gdInfo_"+item.id+"' onclick=gdFunction('"+item.id+"');>"+item.proposeContent+"</a></div><div class='contentright'>"+Util.DateTime.Formater("yyyy-MM-dd",item.proposeTime.time)+"</div></td></tr>";
						$("#myGd").append(tr);
					});
				}
			});
			...
			data:{
				...
				"pageSize":7
					...
					$.each(data.list, function(i,item) {
						var tr = "<tr><td><div class='contentLeft'><img src='/emcc-web/image/poms-business/picture/jg18x18.png' />&nbsp;<a  href='#' class='yjA' id='yjInfo_"+item.id+"'onclick=yjFunction('"+item.id+"');>"+item.oslBugContent+"</a></div><div class='contentright'>"+Util.DateTime.Formater("yyyy-MM-dd",item.oslBugTime.time)+"</div></td></tr>";
						$("#yjInfo").append(tr);
					});
				}
			});
			...
			data:{
				...
				"pageSize":7
					...
					$.each(data.list, function(i,item) {
						var tr = "<tr><td><div class='contentLeft'><img src='/emcc-web/image/poms-business/picture/dt16x16.png' />&nbsp;<a  href='#' class='gdAndDtA' id='dtInfo_"+item.id+"' onclick=dtFunction('"+item.id+"');>"+item.mipTitle+"</a></div><div class='contentright'>"+Util.DateTime.Formater("yyyy-MM-dd",item.mipEdittime.time)+"</div></td></tr>";
						$("#dtInfo").append(tr);
					});
				}
			});
...
<div style="background-color:#e9e9e9;width:1280px; height:555px;">
	...
	<div style="width:160px; height:555px; float:left; border-right:1px solid #D2D2D2; border-bottom:1px solid #999999;background-color:#ffffff;">
		<div style="width:160px;height:228px;">
			...
			<div style="width:160px;height:200px;">
					<img src="/emcc-web/image/poms-business/picture/rw80x100.png" style="margin-top:20px;margin-bottom:20px;"/>
		...
		<div style="width:160px; height:327px;">
			...
			<div style="width:160px;height:299px;   font-size:14px;">
				<div class="leftContent"><img src="/emcc-web/image/poms-business/picture/lj.png" /> <span>公司主页</span></div>
				<div class="leftContent"><img src="/emcc-web/image/poms-business/picture/lj.png" /> <span>公司邮箱</span></div>
			</div>
		</div>
	</div>
	<!--左侧内容end -->
	...
	<div style="width:724px; height:555px; padding-left:10px; padding-top:10px; padding-bottom:10px; margin-right:3px; float:left;">
		<div style="width:721px;height:310px;border:1px solid #D2D2D2; margin-bottom:3px;background-color:#ffffff;">
			<div class="contentTitle">
				<div class="contentLeft"><img src="/emcc-web/image/poms-business/picture/myLog16x16.png" />&nbsp;我的日志</div>
			</div>
			<!--我的日志内容start-->
		...
		<div style="width:721px;height:222px;border:1px solid #D2D2D2;background-color:#ffffff;">
			<div class="contentTitle">
				<div class="contentLeft"><img src="/emcc-web/image/poms-business/picture/gd16x16.png" />&nbsp;我的工单</div>
	...
	<div style="width:373px; height:555px;padding-top:10px; float:left;">
		<div style="width:373px;height:310px;border:1px solid #D2D2D2; margin-bottom:3px;background-color:#ffffff;">
			<div class="contentTitle">
				<div class="contentLeft"><img src="/emcc-web/image/poms-business/picture/yj16x16.png" />&nbsp;故障报警信息</div>
		...
		<div style="width:373px;height:222px;border:1px solid #D2D2D2;background-color:#ffffff;">
			<div class="contentTitle">
				<div class="contentLeft"><img src="/emcc-web/image/poms-business/picture/dt16x16.png" style="border: none;"/>&nbsp;动态信息</div>
...
<!-- 页脚部分 -->
	<div style="height:46px; width:1280px; text-align:right; font-size:13px; line-height:46px; border-top:1px solid #999999;background-color:#e9e9e9;">
		<font size="-1" face="新宋体" color="#333333"> 最新警告信息:<a href="toOperationSysLog.action?m=toYwgzsbPage" class="bka"><img src="/emcc-web/image/poms-business/picture/rightBottom.png" /></a>&nbsp;&nbsp;</font>
	</div>
<!-- 页脚部分 -->
	<!-- 工单详情 -->
