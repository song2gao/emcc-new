...
<body>
<div><iframe id="fileDownloadFrame" name="fileDownloadFrame" src="/emcc-web/component/fileUploadDownload/fileDownload.jsp" group="file" style="border:0; overflow:hidden;"></iframe></div>
<div><iframe id="fileUploadFrame" name="fileUploadFrame" src="/emcc-web/component/fileUploadDownload/fileUpload.jsp" group="file" style="border:0; overflow:hidden;"></iframe></div>
