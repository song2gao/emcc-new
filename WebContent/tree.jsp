...
<html>
	...
	function InitTreeData() {
		$('#MyTree-QuXian').tree({
			url :'monitor/tree?pid=0&type=2',
			checkbox : false,
			//animate : true,
			onBeforeExpand : function(node) {
				
				$('#MyTree-QuXian').tree('options').url = 'monitor/tree?pid='+ node.id+'&type='+node.attributes.type;
...
margin:0px;
	...
	<body style="width:100%;overflow: scroll;overflow-y:hidden;overflow-x:auto">	
			<div class="content_title_01" style="border:0px solid red;">
				<div class="content_title_01_txt">用能点位</div>
			</div>
			<ul class="easyui-tree" style="height:95%;overflow: auto;color:#FFFFFF;" id="MyTree-QuXian">
			</ul>
	</body>
</html>
