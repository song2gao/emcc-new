...
function GetData() {
	...
	BingData("#fhtb", args, 'statistics/dataTable', null);
}
function exportTable(){
	if(mmpCode='31_'){
		title=begindate+"至"+enddate+"用电";
	}else{
		title=begindate+"至"+enddate+"用水";
	}
			...
			<div class="container-fluid paper-wrap bevel tlbr" style="width:100%">
				...
				<div class="content-wrap" style="border: 0px solid green;padding:0px;">
					...
					<div class="col-sm-10" style="float:left;width:100.0%;border: 0px solid red ;padding-left:10px;margin-top: 1%;height:87%;">
						...
						<input type="button" onclick="exportTable()" class="button" style="margin-left:1%;background-color: #008CBA;" value="导出"/>
						</div>
						<!-- 数据列表 -->
