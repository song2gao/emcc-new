 ...
 *
 */
public class MeterDeviceStatusSender extends AbstractConnectSender{
	
	private List<PomsCalculateTerminalDevice> calculates;
	
	public MeterDeviceStatusSender(String ip,int port,List<PomsCalculateTerminalDevice> list){
		super(ip,port);
