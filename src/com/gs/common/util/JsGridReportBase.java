...
//
	 ...
	 *         bgcolor:#CAEAFE; </style>
	 */
	public void exportToExcel(XSSFWorkbook wb,String title)
			throws Exception {
	...
	private HashMap<String, HSSFCellStyle> initStyles(HSSFWorkbook wb) {
		...
		try {
			POIFSFileSystem fs = new POIFSFileSystem(new FileInputStream("d:\\module.xls"));
	...
	public static void main(String[] args){
		...
		String[] row=new String[]{"1:00","1","1","1","1"};
		list.add(row);
		String[] parents=new String[]{"时间","高区","低区"};
		String[][] children=new String[][]{new String[]{""},new String[]{"出水温度","回水温度"},new String[]{"出水温度","回水温度"}};
...
//		report.exportToExcel("test", "admin", td);
		System.out.println();
	}
